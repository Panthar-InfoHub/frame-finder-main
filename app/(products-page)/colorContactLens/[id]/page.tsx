      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="border-t pt-6 space-y-3 text-sm text-gray-700">
            {product.color && (
              <p>
                <strong>Color:</strong> {Array.isArray(product.color) ? product.color.join(", ") : product.color}
              </p>
            )}
            {product.material && (
              <p>
            ...
            {product.type && (
              <p>
                <strong>Type:</strong> {Array.isArray(product.type) ? product.type.join(", ") : product.type}
              </p>
            )}
            {product.description && (
              <p>
