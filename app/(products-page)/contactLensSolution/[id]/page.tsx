import { getLensSolutionId, getProductReview } from "@/actions/products";
...
export default async function ProductPage({ params, searchParams }: ProductPageParams) {
  ...
  const [res, reviews] = await Promise.all([getLensSolutionId(id), getProductReview(id)]);
